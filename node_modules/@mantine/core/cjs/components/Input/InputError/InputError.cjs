...
const varsResolver = require_create_vars_resolver.createVarsResolver((_, { size }) => ({ error: { "--input-error-size": size === void 0 ? void 0 : `calc(${require_get_size.getFontSize(size)} - ${require_rem.rem(2)})` } }));
const InputError = require_factory.factory((_props) => {
	const props = require_use_props.useProps("InputError", null, _props);
...
InputError.classes = require_Input_module.default;
