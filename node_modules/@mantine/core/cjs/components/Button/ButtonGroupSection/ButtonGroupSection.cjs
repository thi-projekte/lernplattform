...
const ButtonGroupSection = require_factory.factory((_props) => {
	const props = require_use_props.useProps("ButtonGroupSection", null, _props);
...
ButtonGroupSection.classes = require_Button_module.default;
