...
//#region packages/@mantine/core/src/components/Avatar/AvatarGroup/AvatarGroup.tsx
const AvatarGroupContext = (0, react.createContext)({ withinGroup: false });
const varsResolver = require_create_vars_resolver.createVarsResolver((_, { spacing }) => ({ group: { "--ag-spacing": require_get_size.getSpacing(spacing) } }));
...
AvatarGroup.classes = require_Avatar_module.default;
