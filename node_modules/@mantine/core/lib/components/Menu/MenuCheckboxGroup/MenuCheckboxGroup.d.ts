...
export declare function MenuCheckboxGroup(_props: MenuCheckboxGroupProps): import("react/jsx-runtime").JSX.Element;
export declare namespace MenuCheckboxGroup {
