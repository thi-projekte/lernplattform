...
class ChatMessageServiceImplTest {
    ...
    void testSendMessageToTopic_Success() {
        ...
        when(mappingRegistry.map(any(ChatMessage.class), eq(ChatMessageDto.class))).thenReturn(expectedDto);
    ...
    void testGetMessages_Success() {
        ...
        PaginationDto<ChatMessage> repositoryPaginationResult = PaginationDto.<ChatMessage>builder()
                .results(List.of(mockMessage))
                .totalPages(5)
                .build();
        ...
        verify(mappingRegistry, times(1)).mapList(repositoryPaginationResult.results, ChatMessageDto.class);
    }
    ...
    void testGetMessages_EmptyResults() {
        ...
        PaginationDto<ChatMessage> emptyPaginationResult = PaginationDto.<ChatMessage>builder()
