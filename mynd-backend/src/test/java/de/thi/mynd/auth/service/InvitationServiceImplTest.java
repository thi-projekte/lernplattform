...
class InvitationServiceImplTest {
    ...
    void testGetInvitation_NotFound_ThrowsException() {
        ...
        assertThrows(EntityInstanceNotFoundException.class, () -> invitationService.getInvitation(invitationId));
    }
    ...
    void testSendInvitation_Success() {
        ...
        verify(genericEmailService, times(1)).sendEmail(
                eq("invitation"),
                eq("MYnd Invitation"),
    ...
    void testSendInvitation_NoInvitationsLeft_ThrowsException() {
        ...
        assertThrows(NoInvitationsLeftException.class, () -> invitationService.sendInvitation("test@test.com"));
    ...
    void testRedeemInvitation_SelfAcceptance_ThrowsException() {
        ...
        assertThrows(CannotAcceptInvitationException.class, () ->
