...
class InvitationResourceTest {
  ...
  @InjectMock InvitationService invitationService;

  @Test
  void testGetInvitation_AnonymousAllowed_Success() {
    UUID invitationId = UUID.randomUUID();
    InvitationDto expectedDto = InvitationDto.builder().id(invitationId).build();
  ...
  void testGetSentInvitations_Authenticated_Success() {
    PaginationDto<InvitationDto> mockPagination =
        PaginationDto.<InvitationDto>builder()
  ...
  void testGetPersonalInvitationStatus_Success() {
    PersonalInvitationStatusDto mockStatus =
        PersonalInvitationStatusDto.builder().invitationsLeft(3).invitationsAlreadySent(2L).build();
