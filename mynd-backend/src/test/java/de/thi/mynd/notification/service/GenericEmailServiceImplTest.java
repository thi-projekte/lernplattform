...
class GenericEmailServiceImplTest {
    ...
    @Inject
    MockMailbox mockMailbox; // Intercepts outgoing emails in test mode
    ...
    void testSendEmail_MultipleRecipients() {
        ...
        Map<String, String> parameters = Map.of("name", "Team", "logoUrl", "...", "invitationLink", "...");
    ...
    void testSendEmail_TemplateNotFound_ThrowsException() {
        ...
        assertEquals(0, mockMailbox.getTotalMessagesSent(), "No email should be broadcasted if compiling template fails");
    }
}