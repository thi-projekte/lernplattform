...
class TopicAssociationServiceImplTest {
    ...
    void testFindOrCreateOwningTopicAssociations_MixedExistingAndNew() {
        ...
        existingAssoc.id = existingTopicId; // In der Logik wird die ID des foreignTopic zur Prüfung genutzt
        ...
        // Act
        List<TopicAssociation> result = topicAssociationService
                .findOrCreateOwningTopicAssociationsOwnedByUserNoFlush(owningTopic, requested, username);
        ...
        TopicAssociation newAssoc = result.stream()
    ...
    void testFindOrCreate_AllExisting() {
        ...
        // Act
        List<TopicAssociation> result = topicAssociationService
                .findOrCreateOwningTopicAssociationsOwnedByUserNoFlush(owningTopic, List.of(req), username);
