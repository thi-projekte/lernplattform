...
class MappingRegistryTest {
    ...
    static class TargetDto {
        String name;
        TargetDto(String name) { this.name = name; }
    }
    ...
    void testMap_Success() {
        ...
        AbstractMappingProcessor<SourceEntity, TargetDto> mockProcessor = mock(AbstractMappingProcessor.class);
    ...
    void testMapList_WithResolver() {
        ...
        // Act
        List<? extends TargetDto> results = mappingRegistry.mapList(List.of(entity), e -> TargetDto.class);
