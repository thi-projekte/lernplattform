    ...
    class UpdateStreakPreferences {
        ...
        void returns200_onValidRequest() {
            ...
            given()
                    ...
                    """)
                    .when().put("/streaks/preferences")
                    .then()
                    .statusCode(200);

            verify(streakService).updateStreakPreferencesForCurrentUser(any(StreakPreferenceRequest.class));
        }
        ...
        void callsServiceWithCorrectValues() {
            ...
            verify(streakService).updateStreakPreferencesForCurrentUser(
        ...
        void returns500_whenServiceThrows() {
            doThrow(new RuntimeException("Unexpected error"))
                    .when(streakService).updateStreakPreferencesForCurrentUser(any());
