...
class TopicNoteResourceTest {
    ...
    void updateTopicNote_withValidRequest_returns200AndUpdatedDto() {
        ...
        when(topicNoteService.updateTopicNoteForCurrentUser(eq(MOCK_TOPIC_ID), any(TopicNoteRequest.class)))
    ...
    void updateTopicNote_withInvalidRequest_returns400() {
        ...
        // Assuming your @Valid triggers on a specific condition (e.g., content is null/empty if @NotBlank is used)
