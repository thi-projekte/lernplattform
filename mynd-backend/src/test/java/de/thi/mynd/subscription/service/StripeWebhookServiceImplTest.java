...
class StripeWebhookServiceImplTest {
    ...
    @Test
    void processWebhook_withInvalidSignature_throwsInvalidStripeSignatureException() throws Exception {
        webhookMock
    ...
    void processWebhook_subscriptionCreated_setsSubscriptionIdAndStatus() throws Exception {
        ...
        verify(subscriptionService).setSubscriptionIdAndStatusForCustomerId(
    ...
    @Test
    void processWebhook_subscriptionCreated_withEmptyDeserializedObject_doesNothing() throws Exception {
    ...
    @Test
    void processWebhook_subscriptionCreated_withNoSubscriptionItems_throwsProductNotFoundException() throws Exception {
    ...
    void processWebhook_subscriptionUpdated_updatesSubscriptionStatus() throws Exception {
        ...
        verify(subscriptionService).setSubscriptionStatusForSubscriptionId(
                SUBSCRIPTION_ID, SubscriptionStatus.PRO
        );
        verify(subscriptionService, never()).setSubscriptionIdAndStatusForCustomerId(any(), any(), any());
    }

    @Test
    void processWebhook_subscriptionUpdated_withCancelAtPeriodEnd_skipsStatusUpdate() throws Exception {
    ...
    @Test
    void processWebhook_subscriptionUpdated_withEmptyDeserializedObject_doesNothing() throws Exception {
    ...
    @Test
    void processWebhook_subscriptionUpdated_withNoSubscriptionItems_throwsProductNotFoundException() throws Exception {
        Subscription stripeSubscription = buildStripeSubscriptionWithNoItems();
        Event event = mockEvent("customer.subscription.updated", stripeSubscription);
        stubWebhook(event);
    ...
    void processWebhook_subscriptionDeleted_setsStatusToFree() throws Exception {
        ...
        verify(subscriptionService).setSubscriptionStatusForSubscriptionId(
                SUBSCRIPTION_ID, SubscriptionStatus.FREE
        );
        verifyNoInteractions(stripeService);
    }

    @Test
    void processWebhook_subscriptionDeleted_withEmptyDeserializedObject_doesNothing() throws Exception {
