...
class StripeServiceImplTest {
    ...
    @Test
    void obtainPriceForSubscriptionStatus_withMatchingProduct_returnsDefaultPrice() throws StripeException {
    ...
    @Test
    void obtainPriceForSubscriptionStatus_withNoMatchingProduct_throwsProductNotFoundException() throws StripeException {
    ...
    @Test
    void obtainPriceForSubscriptionStatus_whenStripeThrows_throwsProductNotFoundException() throws StripeException {
    ...
    @Test
    void obtainPriceForSubscriptionStatus_buildsQueryWithTierAndActiveFilter() throws StripeException {
        Product product = mock(Product.class);
    ...
    void getFullProductById_whenStripeThrows_throwsHandledStripeException() throws StripeException {
        ...
        HandledStripeException ex = assertThrows(
                HandledStripeException.class,
                () -> stripeService.getFullProductById(PRODUCT_ID)
        );
    ...
    @Test
    void createCheckoutSessionForSubscriptionPrice_withValidInputs_returnsSession() throws StripeException {
        Price price = mock(Price.class);
    ...
    @Test
    void createCheckoutSessionForSubscriptionPrice_setsCustomerAndPriceAndMode() throws StripeException {
        Price price = mock(Price.class);
        when(price.getId()).thenReturn(PRICE_ID);
    ...
    @Test
    void createCheckoutSessionForSubscriptionPrice_whenStripeThrows_throwsHandledStripeException() throws StripeException {
        Price price = mock(Price.class);
        when(price.getId()).thenReturn(PRICE_ID);
    ...
    void createBillingPortalSession_withValidCustomerId_returnsSession() throws StripeException {
        com.stripe.model.billingportal.Session session = mock(com.stripe.model.billingportal.Session.class);
        when(billingPortalSessionService.create(any(com.stripe.param.billingportal.SessionCreateParams.class)))
                .thenReturn(session);

        com.stripe.model.billingportal.Session result = stripeService.createBillingPortalSession(CUSTOMER_ID);
    ...
    @Test
    void createBillingPortalSession_whenStripeThrows_throwsHandledStripeException() throws StripeException {
        StripeException stripeException = mock(StripeException.class);
        when(billingPortalSessionService.create(any(com.stripe.param.billingportal.SessionCreateParams.class)))
    ...
    @Test
    void getOrCreateCustomer_whenNoCustomerExists_createsAndReturnsNewCustomer() throws StripeException {
    ...
    void getOrCreateCustomer_searchQueryContainsUsername() throws StripeException {
        StripeSearchResult<Customer> emptyResult = mockSearchResult(Collections.emptyList());
        ArgumentCaptor<CustomerSearchParams> captor = ArgumentCaptor.forClass(CustomerSearchParams.class);
