...
public final class StreakResource {
    ...
    @Operation(
            ...
            description = "Returns all non-ended streaks for the authenticated user. "
    ...
    @Operation(
            ...
            description = "Returns the streak display preferences for the authenticated user. "
    ...
    @Operation(
            ...
            description = "Updates the streak display preferences (type and visibility) "
                    + "for the authenticated user. Creates the preference record if it does not exist yet.")
    @APIResponse(responseCode = "200", description = "Preferences updated successfully")
    @APIResponse(responseCode = "400", description = "Invalid request body")
    @APIResponse(responseCode = "401", description = "User is not authenticated")
    public Response updateStreakPreferences(StreakPreferenceRequest request) {
