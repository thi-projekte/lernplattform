...
public final class LearnProgressResource {
  ...
  @APIResponse(
      responseCode = "409",
      description =
          "This content element has already been completed by the user or the topic has not been started yet")
  @APIResponse(responseCode = "401", description = "User is not authenticated")
  ...
  @Parameter(name = "topicId", description = "ID of the topic to reset progress for", required = true)
