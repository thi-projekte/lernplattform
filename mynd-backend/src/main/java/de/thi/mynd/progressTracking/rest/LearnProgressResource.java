...
public final class LearnProgressResource {
    ...
    @Operation(
            ...
            description = "Returns the current learn progress of the authenticated user for the given topic, including completion status and progress on individual content elements."
    )
    @Parameter(name = "topicId", description = "ID of the topic to retrieve progress for", required = true)
    @APIResponse(
            responseCode = "200",
    ...
    @APIResponse(
            responseCode = "409",
            description = "The user has not started this topic yet"
    )
    @APIResponse(
            responseCode = "401",
    ...
    @Operation(
            ...
            description = "Marks the given topic as started for the authenticated user and records the number of content elements to complete at the time of starting. Has no effect on existing progress."
    )
    @Parameter(name = "topicId", description = "ID of the topic to start", required = true)
    @APIResponse(
            responseCode = "200",
            description = "Topic successfully started"
    )
    @APIResponse(
            responseCode = "409",
            description = "The user has already started this topic"
    )
    @APIResponse(
            responseCode = "401",
            description = "User is not authenticated"
    ...
    @Operation(
            ...
            description = "Marks the given topic as manually completed for the authenticated user, regardless of how many content elements have been completed. The topic must have been started first."
    )
    @Parameter(name = "topicId", description = "ID of the topic to complete", required = true)
    @APIResponse(
            responseCode = "200",
            description = "Topic successfully marked as completed"
    )
    @APIResponse(
            responseCode = "409",
            description = "The user has not started this topic yet"
    ...
    @Parameter(name = "contentElementId", description = "ID of the content element to mark as completed", required = true)
    @APIResponse(
            responseCode = "200",
    ...
    @APIResponse(
            responseCode = "409",
            description = "The parent topic has not been started yet"
    )
    @APIResponse(
            responseCode = "409",
