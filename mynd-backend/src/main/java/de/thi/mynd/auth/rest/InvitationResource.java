...
public final class InvitationResource {
    ...
    @Operation(
            ...
            description = "Retrieves a paginated list of all invitations dispatched by the currently authenticated user.")
    ...
    @Operation(
            ...
            description = "Returns how many invitations the current user has left to send and how many they already processed.")
    ...
    @Operation(
            ...
            description = "Deducts an allowance token from the user profile, creates an active invitation, and emails a dynamic signup link to the recipient.")
    @APIResponse(responseCode = "202", description = "Invitation payload recorded and dispatch pipeline triggered")
    @APIResponse(responseCode = "400", description = "User has exhausted their invitation limits allocation")
    ...
    @Operation(
            ...
            description = "Accepts an invitation, links it to the current user profile context, and provisions access roles.")
    @APIResponse(responseCode = "204", description = "Invitation successfully parsed and onboarding complete")
    @APIResponse(responseCode = "400", description = "Invalid redemption secret provided or user attempted to self-accept")
    ...
    public Response redeemInvitation(
            ...
            @Valid RedeemInvitationDto redeemInvitationDto) {
