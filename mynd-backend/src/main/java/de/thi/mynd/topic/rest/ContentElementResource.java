...
public final class ContentElementResource {
  ...
  @Operation(
      summary = "Creates a new content element",
      description = "Creates a new content element without any topic association")
  @APIResponse(
      responseCode = "201",
      description = "Content Element created",
  ...
  @APIResponse(
      responseCode = "415",
      description =
          "The uploaded file has an invalid media type that is not allowed for this content element type")
  ...
  @Parameter(
      name = "elementId",
      description = "The unique ID of the content element",
      required = true)
