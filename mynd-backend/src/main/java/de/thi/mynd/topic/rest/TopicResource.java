...
public final class TopicResource {
  ...
  @Parameter(
      name = "withOwnedRelatedTopics",
      description =
          "Indicates whether all the related topics that the topic owns should be provided too")
  ...
  @Path("/{topicId}")
  @RolesAllowed("builder")
  @Operation(summary = "Deletes a topic", description = "Deletes the topic with the given ID")
  @APIResponse(responseCode = "404", description = "The topic does not exist")
