...
@ApplicationScoped
public final class FeatureQuotaActionsServiceImpl extends AbstractFeatureQuotaServiceImpl implements FeatureQuotaActionsService {

    @Override
    @Transactional
    public void learnContentElement(String userId) throws FeatureQuotaHitException {
        LocalDate today = LocalDate.now();
        FeatureQuota featureQuota = findOrUpdateOrCreateDefaultQuota(userId, Feature.LearnContentElementOrTopic, today);
        featureQuota.count++;
