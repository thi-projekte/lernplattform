...
export const theme = createTheme({
  ...
  other: {
    layoutHeaderBg: 'var(--layout-header-bg)',
    layoutNavbarBg: 'var(--layout-navbar-bg)',
    layoutMainBg: 'var(--layout-main-bg)',
    layoutBorder: 'var(--layout-border)',
    graphBg: 'var(--graph-bg)',
    graphDots: 'var(--graph-dots)',
    nodeOwnBg: 'var(--node-own-bg)',
    nodeOwnSelectedBg: 'var(--node-own-selected-bg)',
    nodeForeignBg: 'var(--node-foreign-bg)',
    nodeForeignSelectedBg: 'var(--node-foreign-selected-bg)',
    nodeJourneyBg: 'var(--node-journey-bg)',
  },
